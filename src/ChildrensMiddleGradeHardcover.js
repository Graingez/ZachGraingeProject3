...
const ChildrensMiddleGradeHardcover = (props) => {
    ...
    useEffect(() => {
        axios({
            url: `https://api.nytimes.com/svc/books/v3/lists/current/childrens-middle-grade-hardcover.json?`,
            params: {
    ...
    return (
        <section className="BookShelf">
            <h5 className='wrapper'>Here is a list of the top {bookInfo.length} best selling Childrens Hardcover books as of {props.date}</h5>
...
export default ChildrensMiddleGradeHardcover