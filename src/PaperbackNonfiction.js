...
const PaperbackNonfiction = (props) => {


    const [bookInfo, setBookInfo] = useState([]);
    useEffect(() => {
        axios({
            url: `https://api.nytimes.com/svc/books/v3/lists/current/paperback-nonfiction.json?`,
            params: {
    ...
    return (
        <section className="BookShelf">
            <h5 className='wrapper'>Here is a list of the top {bookInfo.length} best selling Graphic Novel/Manga books as of {props.date}</h5>
